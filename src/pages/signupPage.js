...
const SignupPage = () => {
  ...
  const signupHandler = async (event) => {
    ...
    // doesUserNameExists() returns true if the username exists, otherwise it returns false. 
    ...
    if (!usernameExists) {
      ...
      try {
        ...
        // authentication
        // ->emailAddress & password & username(displayName is firebase)
        await createdUserResult.user.updateProfile({
          displayName: username,
        });

        // firestore user -> create a document
